...
export default function FarmerDashboard({ setCurrentView, setSelectedOrderId, onOpenAiModal }) {
  ...
  const handleDeleteListing = (id) => {
    if (window.confirm('क्या आप वाकई इस लिस्टिंग को हटाना चाहते हैं? / Are you sure you want to permanently delete this listing?')) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      {/* 7 PRIMARY FARMER-FIRST ACTION BUTTONS */}
      <div className="bg-white rounded-3xl border border-slate-200/80 p-6 shadow-xs space-y-4">
        <div className="flex flex-wrap items-center justify-between gap-2 border-b border-slate-100 pb-3">
          <div>
            <h2 className="text-sm font-black uppercase tracking-wider text-slate-800 flex items-center gap-2">
              <Sprout className="w-5 h-5 text-brand-600" />
              प्राथमिक किसान सेवाएं / Primary Farmer Services
            </h2>
            <p className="text-xs text-slate-500">
              अपनी आवश्यकतानुसार बटन चुनें या आवाज़ से बोलकर करें
            </p>
          </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-7 gap-3">
          ...
          <a
            ...
            className="p-3.5 rounded-2xl border border-emerald-200 bg-emerald-50/70 hover:bg-emerald-100/80 text-left transition-all group flex flex-col justify-between shadow-2xs"
          >
            <div className="w-9 h-9 rounded-xl bg-emerald-600 text-white flex items-center justify-center font-bold mb-2 group-hover:scale-105 transition-transform shadow-xs">
              <Package className="w-5 h-5" />
            </div>
            <div>
              <span className="font-black text-sm text-slate-900 block">[ मेरी फसल ]</span>
              <span className="text-[11px] text-emerald-800 font-semibold block">My Crops</span>
              <span className="text-[10px] text-slate-500">{activeListings.length} सक्रिय फसलें</span>
            </div>
          </a>
          ...
          <button
            onClick={openAddForm}
            className="p-3.5 rounded-2xl border border-brand-300 bg-brand-50 hover:bg-brand-100 text-left transition-all group flex flex-col justify-between shadow-2xs"
          >
            <div className="w-9 h-9 rounded-xl bg-brand-600 text-white flex items-center justify-center font-bold mb-2 group-hover:scale-105 transition-transform shadow-xs">
              <PlusCircle className="w-5 h-5" />
            </div>
            <div>
              <span className="font-black text-sm text-slate-900 block">[ फसल बेचें ]</span>
              <span className="text-[11px] text-brand-800 font-semibold block">Sell Crop</span>
              <span className="text-[10px] text-slate-500">+ नई फसल जोड़ें</span>
            </div>
          </button>
          ...
          <button
            ...
            className="p-3.5 rounded-2xl border border-blue-200 bg-blue-50/70 hover:bg-blue-100/80 text-left transition-all group flex flex-col justify-between shadow-2xs"
          >
            <div className="w-9 h-9 rounded-xl bg-blue-600 text-white flex items-center justify-center font-bold mb-2 group-hover:scale-105 transition-transform shadow-xs">
              <TrendingUp className="w-5 h-5" />
            </div>
            <div>
              <span className="font-black text-sm text-slate-900 block">[ आज का भाव ]</span>
              <span className="text-[11px] text-blue-800 font-semibold block">Mandi Prices</span>
              <span className="text-[10px] text-slate-500">मंडी रेट और ट्रेंड</span>
            </div>
          </button>
          ...
          <a
            ...
            className="p-3.5 rounded-2xl border border-amber-200 bg-amber-50/70 hover:bg-amber-100/80 text-left transition-all group flex flex-col justify-between shadow-2xs"
          >
            <div className="w-9 h-9 rounded-xl bg-amber-600 text-white flex items-center justify-center font-bold mb-2 group-hover:scale-105 transition-transform shadow-xs">
              <PackageCheck className="w-5 h-5" />
            </div>
            <div>
              <span className="font-black text-sm text-slate-900 block">[ मेरे ऑर्डर ]</span>
              <span className="text-[11px] text-amber-800 font-semibold block">My Orders</span>
              <span className="text-[10px] text-slate-500">{receivedOrders.length} खरीदार ऑर्डर</span>
            </div>
          </a>
          ...
          <a
            ...
            className="p-3.5 rounded-2xl border border-purple-200 bg-purple-50/70 hover:bg-purple-100/80 text-left transition-all group flex flex-col justify-between shadow-2xs"
          >
            <div className="w-9 h-9 rounded-xl bg-purple-600 text-white flex items-center justify-center font-bold mb-2 group-hover:scale-105 transition-transform shadow-xs">
              <Scale className="w-5 h-5" />
            </div>
            <div>
              <span className="font-black text-sm text-slate-900 block">[ मेरा सामान ]</span>
              <span className="text-[11px] text-purple-800 font-semibold block">My Inventory</span>
              <span className="text-[10px] text-slate-500">{formatWeight(totalAvailableKg)} उपलब्ध</span>
            </div>
          </a>
          ...
          >
            <div className="w-9 h-9 rounded-xl bg-teal-600 text-white flex items-center justify-center font-bold mb-2 group-hover:scale-105 transition-transform shadow-xs">
          ...
          <button
            onClick={onOpenAiModal}
            className="p-3.5 rounded-2xl border border-rose-300 bg-gradient-to-br from-rose-50 to-orange-50 hover:from-rose-100 hover:to-orange-100 text-left transition-all group flex flex-col justify-between shadow-2xs ring-1 ring-rose-200"
          >
            <div className="w-9 h-9 rounded-xl bg-rose-600 text-white flex items-center justify-center font-bold mb-2 group-hover:scale-105 transition-transform shadow-xs">
              <Mic className="w-5 h-5 text-amber-300 animate-pulse" />
            </div>
            <div>
              <span className="font-black text-sm text-slate-900 block">[ बोलकर करें ]</span>
              <span className="text-[11px] text-rose-800 font-semibold block">Voice Assistant</span>
              <span className="text-[10px] text-slate-500">माइक दबाकर बोलें</span>
            </div>
          </button>
        </div>
      </div>
                    ...
                    <td className="py-3 px-4 text-right">
                      <div className="flex items-center justify-end gap-2">
                        ...
                        <button
                          ...
                          className="px-2 py-1 rounded-lg text-red-600 hover:text-red-900 hover:bg-red-50 font-semibold text-xs inline-flex items-center gap-1 transition-colors"
